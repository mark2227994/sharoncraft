...
export function buildAdminWhatsAppMessage(order, variant = "seen") {
  ...
  if (variant === "confirmed") {
    return `Hello ${name}, your SharonCraft order ${ref} has been confirmed. We are preparing the next step and will update you shortly.`;
  }
  if (variant === "paid") {
    return `Hello ${name}, payment for your SharonCraft order ${ref} has been received. Thank you. We will share dispatch details as soon as the order is ready.`;
  }
  ...
  return `Hello ${name}, we have seen your SharonCraft order ${ref} and will follow up with you shortly.`;
}
