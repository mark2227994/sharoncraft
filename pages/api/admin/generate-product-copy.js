...
function buildPrompt(body, imageSummaries) {
  ...
  return [
    ...
    "- **IMPORTANT: Always include the shape/style descriptor in the product name** (e.g., 'Uhuru Pendant Necklace', 'Malkia Drop Earrings', 'Kijani Beaded Bracelet', 'Twiga Statement Necklace').",
    "  * For necklaces: include pendant, choker, long, statement, collar, lariat, etc.",
    "  * For earrings: include drop, hoop, stud, chandelier, dangle, huggie, etc.",
    "  * For bracelets: include bangle, beaded, cuff, stretch, tennis, etc.",
    "  * For home decor: include wall hanging, cushion cover, table runner, wall art, etc.",
