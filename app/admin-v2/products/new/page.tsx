...
import { ChangeEvent, DragEvent, type CSSProperties, useRef, useState } from 'react';
...
export default function AddProductPage() {
  ...
  async function handleSave(mode: SaveMode) {
    ...
    try {
      ...
      if (mode === 'publish') {
        updateMessage('Product published successfully', 'success');
        window.setTimeout(() => {
        ...
        <div>
          <section style={panelStyle}>
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                {submittingMode === 'publish' ? 'PUBLISHING...' : 'PUBLISH PRODUCT'}
              </button>
