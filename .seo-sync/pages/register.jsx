...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <>
        <SeoHead title="Check Email - SharonCraft" description="Check your email to confirm" path="/register" noindex />
        <Nav />
  ...
  return (
    <>
      <SeoHead title="Register - SharonCraft" description="Create a SharonCraft account" path="/register" noindex />
      <Nav />
      <main className="auth-page">
        <div className="auth-card">
