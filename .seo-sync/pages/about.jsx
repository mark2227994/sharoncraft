    ...
    async function fetchData() {
      try {
        ...
        if (contentData && contentData.length > 0) {
          setHeroImg(nextSiteImageMap.about_hero || contentData[0].image_url || '')
          setStoryImg(nextSiteImageMap.about_story_image || contentData[0].secondary_image_url || '')
        }
    ...
    <>
        ...
        <section className="about-hero">
          ...
          <div className="hero-right">
            ...
            {loading ? (
              ...
              <Image src={heroImg} fill priority sizes="45vw" className="hero-img" alt="SharonCraft Hero" />
            ) : (
              <div className="hero-fallback" />
            )}
          </div>
      ...
      <style jsx global>{`
        ...
        .hero-texture {
          position: absolute;
          inset: 0;
          background-image: repeating-linear-gradient(135deg, transparent, transparent 40px, rgba(255,255,255,0.012) 40px, rgba(255,255,255,0.012) 41px);
          pointer-events: none;
        }
        .hero-content {
          position: absolute;
        ...
        .hero-blend {
          ...
          bottom: 0;
          width: 160px;
          background: linear-gradient(to right, #0e0a08 0%, rgba(14,10,8,0.7) 50%, transparent 100%);
          pointer-events: none;
          z-index: 1;
        }
        .hero-img {
        ...
        .hero-fallback {
          width: 100%;
          height: 100%;
          background: linear-gradient(145deg, #1a0e08 0%, var(--dark-brown) 40%, var(--brown) 100%);
        }
