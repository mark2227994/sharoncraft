...
export default function BlogPage({ posts, activeCategory }) {
  ...
  return (
    <>
      <SeoHead
        title="Journal - Kenyan Craft Stories"
        description="Stories about Kenyan craft, Maasai beadwork, gifting, care, styling, and the people behind every SharonCraft piece."
        keywords="Kenyan craft stories, Maasai beadwork journal, SharonCraft blog, Nairobi artisan stories"
