...
export default function CustomOrderPage({ heroImage }) {
  ...
  return (
    <>
      <SeoHead
        title="Custom Jewelry Orders Nairobi Kenya"
        description="Order custom handmade Kenyan jewelry. Tell us your vision and our artisans craft it in 5-7 days. Starting from KES 650."
        keywords="custom jewelry Nairobi, custom handmade Kenyan jewelry, bespoke Maasai jewelry, SharonCraft custom order"
        path="/custom-order"
      />
      <Nav />
